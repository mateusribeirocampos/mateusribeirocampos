...
Backend Developer focused on **Java, Spring Boot, PostgreSQL, Docker, and secure REST APIs**.

I build production-oriented backend systems with layered architecture, authentication/authorization, and cloud deployment. I also have a multidisciplinary background in scientific research, which strengthened my analytical thinking, experimentation, and problem-solving skills.

- **Open to:** Junior Backend Java Developer / Backend Software Engineer
- **Core stack:** Java · Spring Boot · Spring Security · JPA/Hibernate · PostgreSQL · Docker
- **Currently improving:** Testing · AWS Cloud · Kubernetes · System Design

---

## Featured Projects

### ⭐ DSCommerce — Flagship Backend Project

Enterprise e-commerce REST API built with **Java, Spring Boot, Spring Security, PostgreSQL, and Docker**, featuring **JWT/OAuth2 authentication, RBAC, validation, JPA domain modeling, pagination, and production deployment**.
